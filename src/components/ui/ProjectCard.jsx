  ...
  return (
    <div className="group relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-300">
      ...
      <div className="p-6 space-y-4">
        <div>
          <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-[#5473FF] transition-colors duration-300">
            {title}
          </h3>
        ...
        {metrics && (
          <div className="flex items-center gap-2 pt-3 border-t border-white/10">
            ...
            <p className="text-xs font-medium text-blue-400">{metrics}</p>
          </div>
        )}
      </div>
    </div>
