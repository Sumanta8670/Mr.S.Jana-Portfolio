      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-xl mx-auto">
              Comprehensive solutions to tyransform your ideas into exceptional
              digital experiences.
            </p>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto ">
          {services.slice(2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={100 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  <div className="mb-4">
                  ...
                  <div className="text-lg font-semibold text-white mb-2 group-hover:text-[#5473FF] transition-colors duration-300">
