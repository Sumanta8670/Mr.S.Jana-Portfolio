...
import { SiAcura } from "react-icons/si";
...
const ProjectSection = () => {
  ...
  // Reset Carousal when category changes
        ...
        <FadeIn delay={0}>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              Showcasing my best work achievements
            </p>
          </div>
        </FadeIn>
        {/* Category Filter */}
            ...
            {filteredProjects.length > 3 && (
              <>
                <button
                  ...
                  className="flex absolute -left-6 lg:-left-12 top-1/2 -translate-y-1/2 -translate-x-2 lg:translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10"
                ...
                <button
                  ...
                  className="flex absolute -right-2 lg:-right-4 top-1/2 -translate-y-1/2 -translate-x-2 lg:translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10"
